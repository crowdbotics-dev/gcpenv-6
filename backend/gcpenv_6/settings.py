"""
Django settings for gcpenv_6 project.
...
WSGI_APPLICATION = 'gcpenv_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gcpenv_6 API",
    "DESCRIPTION": "API documentation for gcpenv_6 App",
    "VERSION": "v1",
}
